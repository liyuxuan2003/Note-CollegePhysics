...
\subsection{气体的等压过程}
    ...
    在等压降温的过程中，理想气体放出的热量，部分来自于其内能的减少，部分源于受外界做功。
...
\subsubsection{等体摩尔热容量}
    ...
    \begin{align}
        ...
        &=\frac{i}{2}\cdot R
    \end{align}\\
    等体摩尔热容量只和气体自由度有关，等体摩尔热容量与温度无关。\\[3mm]
    等体过程的热量还可以表示为：
    \begin{large}
        \begin{equation*}
...
\subsubsection{等压摩尔热容量}
    ...
    \begin{align}
        ...
        &=\frac{i+2}{2}\cdot R
    \end{align}\\
    等压摩尔热容量只和气体自由度有关，等压摩尔热容量与温度无关。\\[3mm]
    等压过程的热量还可以表示为：
    \begin{large}
        \begin{equation*}
...
\newpage
    ...
    \begin{align}
        &~~~~~~~~~~\Delta E=E_2-E_1\\[3mm]
        &~~~~~~~~~~\Delta E=\frac{i}{2}\cdot\frac{m}{M}\cdot R\cdot T_2-\frac{i}{2}\cdot\frac{m}{M}\cdot R\cdot T_1\\[3mm]
        &~~~~~~~~~~\Delta E=\frac{i}{2}\cdot\frac{m}{M}\cdot R\cdot (T_2-T_1)\\[3mm]
        &~~~~~~~~~~\Delta E=\frac{m}{M}\cdot C_{V_m}\cdot(T_2-T_1)
    \end{align}\\
    由热力学第一定律可以得到：
