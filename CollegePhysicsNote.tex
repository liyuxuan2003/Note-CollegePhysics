...
\subsubsection{电偶极子的电场强度}
    电偶极子由两个点电荷构成，电量相对，符号相反。\\[3mm]
    电偶极子的示意图：
    \begin{figure}[h]
        \begin{center}
            \begin{tikzpicture}[scale=1.0]
                ...
                \tkzDefShiftPoint[Q1](-3.0,0){A1}
                \tkzDefShiftPoint[Q2](+3.0,0){A2}
    ...
    通常研究电偶极子在以下两类情况中的场强：\\[3mm]
    1.场点位于电偶极子的轴的延长线上，即位于$A$轴上，此时场点通常记作$A$。\\[3mm]
    2.场点位于电偶极子的轴的中垂线上，即位于$B$轴上，此时场点通常记作$B$。\\[3mm]
    3.通常情况下，我们只研究场点在十分远离电偶极子时的电场情况。

\newpage

\textbf{1.电偶极子轴线的延长线上的电场强度}\\[3mm]
    \setcounter{equation}{0}
    假设在$A$轴上有一点$A$，其至中点的距离的大小为$r$。\\[3mm]
    当场点$A$在中心点右侧且在电偶极子外时：
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}[scale=1.0]
                \tkzDefPoint(0,0){O}
                ...
                \tkzDefShiftPoint[Q1](-5.0,0){A1}
                \tkzDefShiftPoint[Q2](+5.0,0){A2}
                ...
                \tkzDefShiftPoint[Q2](+2.0,0){A}
                \tkzDefShiftPoint[A](+1.5,0){E+}
                \tkzDefShiftPoint[A](-0.5,0){E-}

                \tkzDefShiftPoint[A](0,-0.6){A1}
                \tkzDefShiftPoint[A1](+1.0,0){A2}

                \tkzDrawSegment[-latex](A,E+)
                \tkzDrawSegment[-latex](A,E-)

                \tkzDrawSegment[dashed](A,A1)
                \tkzDrawSegment[-latex](A1,A2)

                \tkzLabelPoint[above](E+){$\veb{E^{+}}$}
                \tkzLabelPoint[above](E-){$\veb{E^{-}}$}

                \tkzLabelPoint[right](A2){$\veb{E_A}$}
                \tkzLabelPoint[below](O){$O$}
    ...
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}[scale=1.0]
                ...
                \tkzDrawPoint[fill=white](A1)
            \end{tikzpicture}
            \caption{场点$A$在中心点左侧且在电偶极子外的情况}
        \end{center}
    \end{figure}\\
    当场点$A$在中心点右侧且在电偶极子间时：
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}[scale=1.0]
                \tkzDefPoint(0,0){O}
                ...
                \tkzDefShiftPoint[Q1](-1.0,0){A1}
                \tkzDefShiftPoint[Q2](+1.0,0){A2}
                ...
                \tkzDefShiftPoint[Q2](-1.0,0){A}
                \tkzDefShiftPoint[A](-1.5,0){E+}
                \tkzDefShiftPoint[A](-0.5,0){E-}

                \tkzDefShiftPoint[A](0,-0.6){A1}
                \tkzDefShiftPoint[A1](-2.0,0){A2}
                ...
                \tkzLabelPoint[left](A2){$\veb{E_A}$}
                \tkzLabelPoint[below](O){$O$}

                \tkzDrawPoint[fill=white](A)
                \tkzDrawPoint[fill=white](A1)
            \end{tikzpicture}
            \caption{场点$A$在中心点右侧且在电偶极子间的情况}
        \end{center}
    \end{figure}\\
    当场点$A$在中心点左侧且在电偶极子间时：
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}[scale=1.0]
                \tkzDefPoint(0,0){O}
...
\newpage
    ...
    \begin{align}
        \begin{cases}
            \veb{E^{+}}=\dfrac{1}{4\pi\cdot\varepsilon_0}\cdot\dfrac{q}{\left(r-\frac{l}{2}\right)^2}\\[6mm]
            \veb{E^{-}}=\dfrac{1}{4\pi\cdot\varepsilon_0}\cdot\dfrac{q}{\left(r+\frac{l}{2}\right)^2}\\[3mm]
    ...
    \begin{align}
        ...
        E_A=E^{-}-E^{+}=\frac{1}{4\pi\cdot\varepsilon_0}\cdot\left[\frac{q}{\left(r-\frac{l}{2}\right)^2}-\frac{q}{\left(r+\frac{l}{2}\right)^2}\right]
    \end{align}\\[1mm]
    观察到两种情况下场强$E_A$的大小实际上是一致的，故可以统一进行求解。\\[8mm]
    变形化简场强$E_A$可得：
    \begin{align}
        &E_A=\frac{1}{4\pi\cdot\varepsilon_0}\cdot\left[\frac{q}{\left(r-\frac{l}{2}\right)^2}-\frac{q}{\left(r+\frac{l}{2}\right)^2}\right]\\[5.5mm]
        &E_A=\frac{q}{4\pi\cdot\varepsilon_0}\cdot\left[\frac{1}{\left(r-\frac{l}{2}\right)^2}-\frac{1}{\left(r+\frac{l}{2}\right)^2}\right]\\[5.5mm]
        &E_A=\frac{q}{4\pi\cdot\varepsilon_0}\cdot\frac{\left(r+\frac{l}{2}\right)^2-\left(r-\frac{l}{2}\right)^2}{\left(r^2-\frac{l}{4}\right)^2}\\[5.5mm]
        &E_A=\frac{q}{4\pi\cdot\varepsilon_0}\cdot\frac{r^2+lr+\frac{l^2}{4}-r^2+lr-\frac{l^2}{4}}{\left(r^2-\frac{l}{4}\right)^2}\\[5.5mm]
        &E_A=\frac{q}{4\pi\cdot\varepsilon_0}\cdot\frac{2\cdot l\cdot r}{\left(r^2-\frac{l}{4}\right)^2}\\[5.5mm]
        &E_A=\frac{1}{4\pi\cdot\varepsilon_0}\cdot\frac{2\cdot q\cdot l\cdot r}{\left(r^2-\frac{l}{4}\right)^2}\\[5.5mm]
...
\newpage
    ...
    \begin{large}
        ...
        \end{equation*}
    \end{large}\\
    此处的近似假设为$r\gg l$，故可以近似认为$\left(r^2-\frac{l}{4}\right)^2=r^4$从而得到近似值。\\[10mm]
    ...
    该图像中，灰色实线代表电场强度近似值的函数曲线。\\[3mm]
    此处为了完整另行计算绘制了两个电偶极子间的电场强度的函数曲线。

\newpage

\textbf{2.电偶极子轴线的中垂线上的电场强度}\\[3mm]
    \setcounter{equation}{0}
    ...
    \end{align}\\
    由于场点$B$处$E^+$和$E^-$方向不同，故场点$B$处的场强的大小为：$E_B=\cos{\theta}\cdot\left(E^++E^-\right)$。
...
\newpage
    ...
    \begin{align}
        E^-=\frac{1}{4\pi\cdot\varepsilon_0}\cdot\frac{q}{r^2+\frac{l^2}{4}}
    \end{align}\\
    观察可知正电荷和负电荷在场点$B$产生的场强是一致的，即有$E^+=E^-$。\\[14mm]
    变形化简场强$E_B$可得：
    \begin{align}
        &E_B=\cos{\theta}\cdot\left(E^++E^-\right)\\[8mm]
        &E_B=2\cdot\cos{\theta}\cdot E^+\\[8mm]
        &E_B=2\cdot\frac{\frac{l}{2}}{\sqrt{r^2+\frac{l^2}{4}}}\cdot\frac{1}{4\pi\cdot\varepsilon_0}\cdot\frac{q}{r^2+\frac{l^2}{4}}\\[8mm]
        &E_B=\frac{1}{4\pi\cdot\varepsilon_0}\cdot\frac{q}{r^2+\frac{l^2}{4}}\cdot\frac{l}{\sqrt{r^2+\frac{l^2}{4}}}\\[8mm]
        &E_B=\frac{1}{4\pi\cdot\varepsilon_0}\cdot\frac{q}{\left(r^2+\frac{l^2}{4}\right)^{1\vphantom{\frac{1}{1}}}}\cdot\frac{l}{\left(r^2+\frac{l^2}{4}\right)^{\frac{1}{2}}}\\[8mm]
        &E_B=\frac{1}{4\pi\cdot\varepsilon_0}\cdot\frac{q\cdot l}{\left(r^2+\frac{l^2}{4}\right)^{\frac{3}{2}}}\\[8mm]
...
\newpage
    ...
    \begin{large}
        ...
        \end{equation*}
    \end{large}\\
    此处的近似假设为$r\gg l$，故可以近似认为$\left(r^2-\frac{l}{4}\right)^{\frac{3}{2}}=r^3$从而得到近似值。\\[10mm]
