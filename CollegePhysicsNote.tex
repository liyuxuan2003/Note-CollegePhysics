...
\subsection{气体的等体过程}
    ...
    \begin{large}
        ...
        \end{align*}
    \end{large}\\
    气体的等体过程中，系统吸收的全部热量用于内能增加，其中$\Delta E=\dfrac{i}{2}\cdot\dfrac{m}{M}\cdot R\cdot(T_2-T_1)$。
...
\subsection{气体的等压过程}
    ...
    \begin{large}
        ...
        \end{align*}
    \end{large}\\
    气体的等压过程中，系统吸收的部分热量用于内能增加，其中$\Delta E=\dfrac{i}{2}\cdot\dfrac{m}{M}\cdot R\cdot(T_2-T_1)$。\\[3mm]
    气体的等压过程中，系统吸收的部分热量用于对外做功，其中$W=\dfrac{m}{M}\cdot R\cdot(T_2-T_1)$。
...
\subsection{气体的等温过程}
    ...
    \begin{large}
        \begin{align*}
            &Q_T=W\\[3mm]
            &Q_T=\frac{m}{M}\cdot R\cdot T\cdot\ln{\frac{V_2}{V_1}}\\[3mm]
